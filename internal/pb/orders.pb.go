...
func (x *GetOrdersResponse) Reset() {
	*x = GetOrdersResponse{}
	mi := &file_internal_pb_orders_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetOrdersResponse) Descriptor() ([]byte, []int) {
	return file_internal_pb_orders_proto_rawDescGZIP(), []int{5}
}
...
func (x *GetOrderByIdResponse) Reset() {
	*x = GetOrderByIdResponse{}
	mi := &file_internal_pb_orders_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetOrderByIdResponse) Descriptor() ([]byte, []int) {
	return file_internal_pb_orders_proto_rawDescGZIP(), []int{6}
}
...
const file_internal_pb_orders_proto_rawDesc = "" +
	"\n" +
	"\x18internal/pb/orders.proto\x12\torders.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"L\n" +
	"\x04Item\x12\x12\n" +
	...
	"\fGetOrderById\x12\x1e.orders.v1.GetOrderByIdRequest\x1a\x1f.orders.v1.GetOrderByIdResponseB\rZ\vinternal/pbb\x06proto3"
...
var file_internal_pb_orders_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
